...
static String aColor = "blu";
    ...
    private static Pose2d allianceCoordinate(Pose2d coordinate) {
        if(aColor == "blue"){
            mirroredCoordinate =new Pose2d(new Vector2d(coordinate.getX(), coordinate.getY() * -1) , Math.toRadians((Math.toDegrees(coordinate.getHeading()) - 180) * -1 + 180));
