...
public class BotPositions {
    ...
    public static double TURRET_P = 0.000035 /*0.00003*/ , TURRET_I = 0.000, TURRET_D = 0.0000, TURRET_S = 2.7,  TURRET_V = 0.0004, TURRET_TOLERANCE_DEG = 1;
    ...
    public static double GATE_OPEN = .2, GATE_CLOSED = .37, KICKER_UP = .60, KICKER_DOWN = .31, SLOT_STORED = .53, SLOT_FLY = .9, BACK_OPEN = .44, BACK_CLOSE = .57;
