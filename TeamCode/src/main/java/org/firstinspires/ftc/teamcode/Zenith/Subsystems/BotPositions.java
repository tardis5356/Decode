...
public class BotPositions {
   ...
   public static double TURRET_P = 0.00015 , TURRET_I = 0, TURRET_D = 0.0000046, TURRET_S = 0.09,  TURRET_V = 0, TURRET_TOLERANCE_DEG = 1;
    ...
    //PTO Relevant stuff
    public static double PTO_ENGAGED = 0.38, PTO_DISENGAGED = 0, BELLYPAN_LEFT_LATCHED = 0.27, BELLYPAN_RIGHT_LATCHED = 0.6, BELLYPAN_LEFT_UNLATCHED = 0., BELLYPAN_RIGHT_UNLATCHED = 0.2;
    ...
    public static double GATE_OPEN = .54, GATE_CLOSED = .39, KICKER_UP = .65, KICKER_DOWN = .28, SLOT_STORED = .53, SLOT_FLY = .89, BACK_OPEN = .44, BACK_CLOSE = .5;

    public static long KICKER_WAIT = 300, GATE_WAIT = 1500, SWAP_WAIT = 500, INTAKE_WAIT = 700;
