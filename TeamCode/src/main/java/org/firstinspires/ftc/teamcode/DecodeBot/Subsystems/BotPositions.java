...
public class BotPositions {
    ...
    public static double TURRET_P = 0.004, TURRET_I = 0.000, TURRET_D = 0.000001;
    public static double TURRET_360_TURN_TICKS = 380 * 90/100 * 360/365  /*39,253*/, TURRET_DEGREE_TO_TICK_MULTIPLIER = TURRET_360_TURN_TICKS/360, TURRET_TICK_TO_RADIAN_MULTIPLIER = TURRET_DEGREE_TO_TICK_MULTIPLIER * (Math.PI/180);
   ...
   //PTO Relevant stuff
    ...
    public static double CAMERA_RADIUS = 1.75 /*5.23956*/, TURRET_OFFSET_X = -3.25/*-2.5590*/, TURRET_OFFSET_Y = -3/*0*/;
