...
public class BotPositions {
    ...
    public static double TURRET_TICKS_PER_DEGREE = -(8192/360)*(373.6/360)*(358.91083/360) /*1.0346380099*/  /*39,253*/, TURRET_RADIANS_PER_TICK = 1/(TURRET_TICKS_PER_DEGREE) * (Math.PI/180);
   ...
   //PTO Relevant stuff
    ...
    public static double CAMERA_RADIUS = 1.5 /*5.23956*/, TURRET_OFFSET_X = -3.25/*-2.5590*/, TURRET_OFFSET_Y = -3/*0*/;
